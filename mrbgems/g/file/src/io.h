...
mrb_value rb_io_get_io(mrb_value io);
mrb_value rb_io_get_write_io(mrb_value io);
mrb_value rb_io_set_write_io(mrb_value io, mrb_value w);
int rb_io_wait_readable(int);
int rb_io_wait_writable(int);
int rb_wait_for_single_fd(int fd, int events, struct timeval *tv);
void rb_io_set_nonblock(rb_io_t *fptr);
int rb_io_extract_encoding_option(mrb_value opt, mrb_encoding **enc_p, mrb_encoding **enc2_p, int *fmode_p);
ssize_t rb_io_bufwrite(mrb_value io, const void *buf, size_t size);
...
mrb_value rb_io_taint_check(mrb_value);
