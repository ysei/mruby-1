...
#define E_SECURITY_ERROR             (mrb_class_obj_get(mrb, "SecurityError"))
...
mrb_value rb_cIO;
mrb_value rb_eEOFError;
mrb_value rb_eIOError;
mrb_value rb_mWaitReadable;
mrb_value rb_mWaitWritable;

mrb_value rb_stdin, rb_stdout, rb_stderr;
mrb_value rb_deferr;		/* rescue VIM plugin */
static mrb_value orig_stdout, orig_stderr;

mrb_value rb_output_fs;
mrb_value rb_rs;
mrb_value rb_output_rs;
mrb_value rb_default_rs;
...
#else
static int
is_socket(int fd, mrb_value path)
{
    struct stat sbuf;
    if (fstat(fd, &sbuf) < 0)
...
mrb_value
rb_io_taint_check(mrb_value io)
{
    if (!OBJ_UNTRUSTED(io) && rb_safe_level() >= 4)
	mrb_raise(E_RUNTIME_ERROR, "Insecure: operation on trusted IO");
    rb_check_frozen(io);
    return io;
}
...
mrb_value
rb_io_get_io(mrb_value io)
{
    return rb_convert_type(io, T_FILE, "IO", "to_io");
}

static mrb_value
rb_io_check_io(mrb_value io)
{
    return rb_check_convert_type(io, T_FILE, "IO", "to_io");
}

mrb_value
rb_io_get_write_io(mrb_value io)
{
    mrb_value write_io;
...
mrb_value
rb_io_set_write_io(mrb_value io, mrb_value w)
{
    mrb_value write_io;
    rb_io_check_initialized(RFILE(io)->fptr);
    if (!RTEST(w)) {
 ...
 */
static mrb_value
rb_io_s_try_convert(mrb_value dummy, mrb_value io)
{
...
static void
io_ungetbyte(mrb_value str, rb_io_t *fptr)
{
...
static mrb_value
io_flush_buffer_async(mrb_value arg)
{
...
{
    if (fptr->write_lock) {
	return (int)rb_mutex_synchronize(fptr->write_lock, io_flush_buffer_async, (mrb_value)fptr);
    }
    else {
...
static mrb_value
io_binwrite_string(mrb_value arg)
{
...
static long
io_binwrite(mrb_value str, const char *ptr, long len, rb_io_t *fptr, int nosync)
{
    long n, r, offset = 0;
	...
	arg.length = n;
	if (fptr->write_lock) {
	    r = rb_mutex_synchronize(fptr->write_lock, io_binwrite_string, (mrb_value)&arg);
	}
	else {
...
static mrb_value
do_writeconv(mrb_value str, rb_io_t *fptr)
{
...
static long
io_fwrite(mrb_value str, rb_io_t *fptr, int nosync)
{
#ifdef _WIN32
...
ssize_t
rb_io_bufwrite(mrb_value io, const void *buf, size_t size)
{
    rb_io_t *fptr;
...
static mrb_value
io_write(mrb_value io, mrb_value str, int nosync)
{
    rb_io_t *fptr;
    long n;
    mrb_value tmp;
...
static mrb_value
io_write_m(mrb_value io, mrb_value str)
{
    return io_write(io, str, 0);
}

mrb_value
rb_io_write(mrb_value io, mrb_value str)
{
    return rb_funcall(io, id_write, 1, str);
}
...
mrb_value
rb_io_addstr(mrb_value io, mrb_value str)
{
    rb_io_write(io, str);
    return io;
}
...
static mrb_value
rb_io_seek(mrb_value io, mrb_value offset, int whence)
{
    rb_io_t *fptr;
    off_t pos;
 ...
 *  the mrb_value of <i>whence</i>:
 *
 *    IO::SEEK_CUR  | Seeks to _amount_ plus current position
 *    --------------+----------------------------------------------------
 *    IO::SEEK_END  | Seeks to _amount_ plus end of stream (you probably
 *                  | want a negative mrb_value for _amount_)
 *    --------------+----------------------------------------------------
...
static mrb_value
rb_io_seek_m(int argc, mrb_value *argv, mrb_value io)
{
...
static mrb_value
rb_io_set_pos(mrb_value io, mrb_value offset)
{
    rb_io_t *fptr;
    off_t pos;
...
static mrb_value
rb_io_set_sync(mrb_value io, mrb_value sync)
{
    rb_io_t *fptr;
...
static long
io_fread(mrb_value str, long offset, rb_io_t *fptr)
{
    long len;
...
ssize_t
rb_io_bufread(mrb_value io, void *buf, size_t size)
{
    rb_io_t *fptr;
...
static mrb_value
io_enc_str(mrb_value str, rb_io_t *fptr)
{
    OBJ_TAINT(str);
...
static mrb_value
io_shift_cbuf(rb_io_t *fptr, int len, mrb_value *strp)
{
    mrb_value str = Qnil;
    if (strp) {
	str = *strp;
...
static void
io_setstrbuf(mrb_value *str,long len)
{
#ifdef _WIN32
    if (NIL_P(*str)) {
...
static mrb_value
read_all(rb_io_t *fptr, long siz, mrb_value str)
{
    long bytes;
    long n;
    long pos;
...
static mrb_value
io_getpartial(int argc, mrb_value *argv, mrb_value io, int nonblock)
{
    rb_io_t *fptr;
...
static mrb_value
io_readpartial(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value ret;
...
static mrb_value
io_read_nonblock(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value ret;
...
static mrb_value
rb_io_write_nonblock(mrb_value io, mrb_value str)
{
    rb_io_t *fptr;
    long n;
...
static mrb_value
io_read(int argc, mrb_value *argv, mrb_value io)
{
    rb_io_t *fptr;
    long n, len;
    mrb_value length, str;
...
static void
rscheck(const char *rsptr, long rslen, mrb_value rs)
{
    if (!rs) return;
...
static int
appendline(rb_io_t *fptr, int delim, mrb_value *strp, long *lp)
{
    mrb_value str = *strp;
    long limit = *lp;
...
static mrb_value
rb_io_getline_fast(rb_io_t *fptr, rb_encoding *enc, mrb_value io)
{
    mrb_value str = Qnil;
    int len = 0;
    long pos = 0;
...
static void
prepare_getline_args(int argc, mrb_value *argv, mrb_value *rsp, long *limit, mrb_value io)
{
    mrb_value rs = rb_rs, lim = Qnil;
    rb_io_t *fptr;
...
static mrb_value
rb_io_getline_1(mrb_value rs, long limit, mrb_value io)
{
    mrb_value str = Qnil;
    rb_io_t *fptr;
    int nolimit = 0;
...
static mrb_value
rb_io_getline(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value rs;
    long limit;
...
static mrb_value
rb_io_gets_m(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value str;
 ...
 *  mrb_values will differ if #gets is called with a separator other than newline.
 *
 ...
 *
 *  Manually sets the current line number to the given mrb_value.
...
static mrb_value
rb_io_set_lineno(mrb_value io, mrb_value lineno)
{
    rb_io_t *fptr;
...
static mrb_value
rb_io_readline(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value line = rb_io_gets_m(argc, argv, io);
 ...
 *  longer than the given mrb_value in bytes. The stream must be opened for
...
static mrb_value
rb_io_readlines(int argc, mrb_value *argv, mrb_value io)
{
...
static mrb_value
rb_io_each_line(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value str, rs;
    long limit;
...
static mrb_value
rb_io_each_codepoint(mrb_value io)
{
    rb_io_t *fptr;
    rb_encoding *enc;
    unsigned int c;
...
static mrb_value
rb_io_readchar(mrb_value io)
{
    mrb_value c = rb_io_getc(io);
...
static mrb_value
rb_io_readbyte(mrb_value io)
{
    mrb_value c = rb_io_getbyte(io);
...
mrb_value
rb_io_ungetbyte(mrb_value io, mrb_value b)
{
    rb_io_t *fptr;
...
mrb_value
rb_io_ungetc(mrb_value io, mrb_value c)
{
    rb_io_t *fptr;
    long len;
...
static mrb_value
rb_io_close_on_exec_p(mrb_value io)
{
    rb_io_t *fptr;
    mrb_value write_io;
    int fd, ret;
...
static mrb_value
rb_io_set_close_on_exec(mrb_value io, mrb_value arg)
{
...
static mrb_value
finish_writeconv_sync(mrb_value arg)
{
...
fptr_finalize(rb_io_t *fptr, int noraise)
{
	...
	if (fptr->write_lock && !noraise) {
            ...
            arg.fptr = fptr;
            arg.noalloc = noraise;
            err = rb_mutex_synchronize(fptr->write_lock, finish_writeconv_sync, (mrb_value)&arg);
	}
	else {
...
static mrb_value
io_call_close(mrb_value io)
{
    return rb_funcall(io, rb_intern("close"), 0, 0);
}

static mrb_value
io_close(mrb_value io)
{
...
static mrb_value
rb_io_close_write(mrb_value io)
{
    rb_io_t *fptr;
    mrb_value write_io;
 ...
 *
 *  Seeks to a given <i>offset</i> in the stream according to the mrb_value
 *  of <i>whence</i> (see <code>IO#seek</code> for mrb_values of
...
static mrb_value
rb_io_sysseek(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value offset, ptrname;
    int whence = SEEK_SET;
    rb_io_t *fptr;
...
static mrb_value
rb_io_syswrite(mrb_value io, mrb_value str)
{
    rb_io_t *fptr;
    long n;
...
static mrb_value
rb_io_sysread(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value len, str;
    rb_io_t *fptr;
    long n, ilen;
...
mrb_value
rb_io_ascii8bit_binmode(mrb_value io)
{
    rb_io_t *fptr;
...
int
rb_io_extract_encoding_option(mrb_value opt, rb_encoding **enc_p, rb_encoding **enc2_p, int *fmode_p)
{
	...
	if (!NIL_P(ruby_verbose)) {
	    ...
	    rb_warn("Ignoring encoding parameter '%s': %s_encoding is used",
		    idx < 0 ? Stringmrb_valueCStr(encoding) : rb_enc_name(rb_enc_from_index(idx)),
	...
	if (NIL_P(intenc)) {
	    ...
	    char *p = Stringmrb_valueCStr(tmp);
	...
	if (!NIL_P(tmp = rb_check_string_type(encoding))) {
	    parse_mode_enc(Stringmrb_valueCStr(tmp), enc_p, enc2_p, fmode_p);
	}
	else {
...
static void
extract_binmode(mrb_value opthash, int *fmode)
{
    if (!NIL_P(opthash)) {
	mrb_value v;
...
static void
rb_io_extract_modeenc(mrb_value *vmode_p, mrb_value *vperm_p, mrb_value opthash,
        int *oflags_p, int *fmode_p, convconfig_t *convconfig_p)
{
  ...
  vmode_handle:
    if (NIL_P(vmode)) {
        ...
        SafeStringmrb_value(vmode);
        p = Stringmrb_valueCStr(vmode);
...
static int
rb_sysopen(mrb_value fname, int oflags, mode_t perm)
{
    int fd;
...
static mrb_value rb_io_internal_encoding(mrb_value);
static void io_encoding_set(rb_io_t *, mrb_value, mrb_value, mrb_value);

static int
io_strip_bom(mrb_value io)
{
...
static void
io_set_encoding_by_bom(mrb_value io)
{
...
static mrb_value
rb_file_open_generic(mrb_value io, mrb_value filename, int oflags, int fmode, convconfig_t *convconfig, mode_t perm)
{
    rb_io_t *fptr;
    convconfig_t cc;
    if (!convconfig) {
...
static mrb_value
rb_file_open_internal(mrb_value io, mrb_value filename, const char *modestr)
{
...
mrb_value
rb_file_open_str(mrb_value fname, const char *modestr)
{
    FilePathmrb_value(fname);
...
void
rb_close_before_exec(int lowfd, int maxhint, mrb_value noclose_fds)
{
    int fd, ret;
...
static mrb_value
pipe_open(struct rb_exec_arg *eargp, mrb_value prog, const char *modestr, int fmode, convconfig_t *convconfig)
{
    rb_pid_t pid = 0;
    rb_io_t *fptr;
    mrb_value port;
	...
	for (i = 0; i < argc; ++i) {
	    args[i] = Stringmrb_valueCStr(argv[i]);
	}
	args[i] = NULL;
    }
    switch (fmode & (FMODE_READABLE|FMODE_WRITABLE)) {
...
static mrb_value
pipe_open_v(int argc, mrb_value *argv, const char *modestr, int fmode, convconfig_t *convconfig)
{
    mrb_value prog;
...
static mrb_value
pipe_open_s(mrb_value prog, const char *modestr, int fmode, convconfig_t *convconfig)
{
...
static mrb_value
rb_io_s_popen(int argc, mrb_value *argv, mrb_value klass)
{
    const char *modestr;
...
static void
rb_scan_open_args(int argc, mrb_value *argv,
...
static mrb_value
rb_open_file(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value fname;
    int oflags, fmode;
    convconfig_t convconfig;
 ...
 *  <code>File.open</code> returns the mrb_value of the block.
 *
 *  See IO.new for a list of mrb_values for the +opt+ parameter.
 */
 ...
 *  terminates. In this instance, IO.open returns the mrb_value of the block.
 *
 *  See IO.new for a description of mrb_values for the +opt+ parameter.
 *
 */

static mrb_value
rb_io_s_open(int argc, mrb_value *argv, mrb_value klass)
{
    mrb_value io = rb_class_new_instance(argc, argv, klass);
...
static mrb_value
rb_io_s_sysopen(int argc, mrb_value *argv)
{
	...
	SafeStringmrb_value(vmode);
	oflags = rb_io_modestr_oflags(Stringmrb_valueCStr(vmode));
    }
...
static mrb_value
check_pipe_command(mrb_value filename_or_command)
{
    ...
    if (rb_enc_ascget(s, e, &chlen, rb_enc_get(filename_or_command)) == '|') {
        mrb_value cmd = rb_str_new(s+chlen, l-chlen);
 ...
 *  returns the mrb_value of the block.
 *
...
static mrb_value
rb_f_open(int argc, mrb_value *argv)
{
    ID to_open = 0;
    int redirect = FALSE;
    ...
    if (redirect) {
	mrb_value io = rb_funcall2(argv[0], to_open, argc-1, argv+1);
...
static mrb_value
rb_io_open(mrb_value filename, mrb_value vmode, mrb_value vperm, mrb_value opt)
{
    mrb_value cmd;
    int oflags, fmode;
    convconfig_t convconfig;
...
static mrb_value
rb_io_open_with_args(int argc, mrb_value *argv)
{
    mrb_value io;
...
static mrb_value
io_reopen(mrb_value io, mrb_value nfile)
{
    rb_io_t *fptr, *orig;
    int fd, fd2;
    off_t pos = 0;
...
static mrb_value
rb_io_reopen(int argc, mrb_value *argv, mrb_value file)
{
	...
	mrb_value tmp = rb_io_check_io(fname);
	if (!NIL_P(tmp)) {
    ...
    if (!NIL_P(nmode)) {
	int fmode = rb_io_modestr_fmode(Stringmrb_valueCStr(nmode));
	if (IS_PREP_STDIO(fptr) &&
	...
	fptr->mode = fmode;
	rb_io_mode_enc(fptr, Stringmrb_valueCStr(nmode));
        fptr->encs.ecflags = 0;
        fptr->encs.ecopts = Qnil;
    }
...
/* :nodoc: */
static mrb_value
rb_io_init_copy(mrb_value dest, mrb_value io)
{
    rb_io_t *fptr, *orig;
    int fd;
    mrb_value write_io;
...
mrb_value
rb_io_printf(int argc, mrb_value *argv, mrb_value out)
{
...
static mrb_value
rb_f_printf(int argc, mrb_value *argv)
{
    mrb_value out;
...
mrb_value
rb_io_print(int argc, mrb_value *argv, mrb_value out)
{
    int i;
    mrb_value line;
...
static mrb_value
rb_f_print(int argc, mrb_value *argv)
{
...
static mrb_value
rb_io_putc(mrb_value io, mrb_value ch)
{
    mrb_value str;
    if (TYPE(ch) == T_STRING) {
...
static mrb_value
rb_f_putc(mrb_value recv, mrb_value ch)
{
    if (recv == rb_stdout) {
...
static int
str_end_with_asciichar(mrb_value str, int c)
{
    long len = RSTRING_LEN(str);
...
static mrb_value
io_puts_ary(mrb_value ary, mrb_value out, int recur)
{
    mrb_value tmp;
    long i;
...
mrb_value
rb_io_puts(int argc, mrb_value *argv, mrb_value out)
{
    int i;
    mrb_value line;
...
static mrb_value
rb_f_puts(int argc, mrb_value *argv, mrb_value recv)
{
    if (recv == rb_stdout) {
...
void
rb_p(mrb_value obj) /* for debug print within C code */
{
    mrb_value str = rb_obj_as_string(rb_inspect(obj));
...
static mrb_value
rb_f_p(int argc, mrb_value *argv, mrb_value self)
{
    int i;
    mrb_value ret = Qnil;
...
static mrb_value
rb_obj_display(int argc, mrb_value *argv, mrb_value self)
{
    mrb_value out;
...
static void
must_respond_to(ID mid, mrb_value val, ID id)
{
...
static void
stdout_setter(mrb_value val, ID id, mrb_value *variable)
{
...
static mrb_value
prep_io(int fd, int fmode, mrb_value klass, const char *path)
{
    rb_io_t *fp;
...
static mrb_value
prep_stdio(FILE *f, int fmode, mrb_value klass, const char *path)
{
    rb_io_t *fptr;
 ...
 *    encoding.
 *
 *    If the mrb_value is nil no conversion occurs.
 *  :encoding ::
 *    Specifies external and internal encodings as "extern:intern".
 *  :textmode ::
 *    If the mrb_value is truth mrb_value, same as "t" in argument +mode+.
 *  :binmode ::
 *    If the mrb_value is truth mrb_value, same as "b" in argument +mode+.
 *  :autoclose ::
 *    If the mrb_value is +false+, the +fd+ will be kept open after this IO
...
static mrb_value
rb_io_initialize(int argc, mrb_value *argv, mrb_value io)
{
...
static mrb_value
rb_file_initialize(int argc, mrb_value *argv, mrb_value io)
{
    if (RFILE(io)->fptr) {
	rb_raise(rb_eRuntimeError, "reinitializing File");
    }
    if (0 < argc && argc < 3) {
	mrb_value fd = rb_check_convert_type(argv[0], T_FIXNUM, "Fixnum", "to_int");
...
/* :nodoc: */
static mrb_value
rb_io_s_new(int argc, mrb_value *argv, mrb_value klass)
{
    if (rb_block_given_p()) {
...
static mrb_value
rb_io_s_for_fd(int argc, mrb_value *argv, mrb_value klass)
{
    mrb_value io = rb_obj_alloc(klass);
...
static mrb_value
rb_io_autoclose_p(mrb_value io)
{
    rb_io_t *fptr;
    rb_secure(4);
    GetOpenFile(io, fptr);
...
static mrb_value
rb_io_set_autoclose(mrb_value io, mrb_value autoclose)
{
    rb_io_t *fptr;
    rb_secure(4);
    GetOpenFile(io, fptr);
...
static inline void
argf_init(struct argf *p, mrb_value v)
{
    p->filename = Qnil;
    p->current_file = Qnil;
    p->lineno = 0;
...
/* :nodoc: */
static mrb_value
argf_initialize(mrb_value argf, mrb_value argv)
{
...
/* :nodoc: */
static mrb_value
argf_initialize_copy(mrb_value argf, mrb_value orig)
{
    ARGF = argf_of(orig);
 ...
 */
static mrb_value
argf_set_lineno(mrb_value argf, mrb_value val)
{
 ...
 *     ARGF.lineno -> integer
 *
 *  Returns the current line number of ARGF as a whole. This mrb_value
 ...
 */
static mrb_value
argf_lineno(mrb_value argf)
{
    return INT2FIX(ARGF.lineno);
}

static mrb_value
argf_forward(int argc, mrb_value *argv, mrb_value argf)
{
...
argf_next_argv(mrb_value argf)
{
	...
	if (RARRAY_LEN(ARGF.argv) > 0) {
	    ...
	    fn = Stringmrb_valueCStr(ARGF.filename);
	    if (strlen(fn) == 1 && fn[0] == '-') {
...
static mrb_value
argf_getline(int argc, mrb_value *argv, mrb_value argf)
{
    mrb_value line;
...
static mrb_value
argf_lineno_getter(ID id, mrb_value *var)
{
    mrb_value argf = *var;
...
static void
argf_lineno_setter(mrb_value val, ID id, mrb_value *var)
{
    mrb_value argf = *var;
    int n = NUM2INT(val);
 ...
 *  would not be longer than the given mrb_value in bytes.  If multiple
...
static mrb_value
rb_f_gets(int argc, mrb_value *argv, mrb_value recv)
{
    if (recv == argf) {
 ...
 */
static mrb_value
argf_gets(int argc, mrb_value *argv, mrb_value argf)
{
    mrb_value line;
...
static mrb_value
rb_f_readline(int argc, mrb_value *argv, mrb_value recv)
{
    if (recv == argf) {
 ...
 */
static mrb_value
argf_readline(int argc, mrb_value *argv, mrb_value argf)
{
    mrb_value line;
...
static mrb_value
rb_f_readlines(int argc, mrb_value *argv, mrb_value recv)
{
    if (recv == argf) {
 ...
 */
static mrb_value
argf_readlines(int argc, mrb_value *argv, mrb_value argf)
{
    long lineno = ARGF.lineno;
    mrb_value lines, ary;
...
static mrb_value
rb_f_backquote(mrb_value obj, mrb_value str)
{
    volatile mrb_value port;
    mrb_value result;
    rb_io_t *fptr;

    SafeStringmrb_value(str);
...
static mrb_value
select_internal(mrb_value read, mrb_value write, mrb_value except, struct timeval *tp, rb_fdset_t *fds)
{
    mrb_value res, list;
    rb_fdset_t *rp, *wp, *ep;
    rb_io_t *fptr;
	...
	for (i=0; i<RARRAY_LEN(write); i++) {
            mrb_value write_io = GetWriteIO(rb_io_get_io(RARRAY_PTR(write)[i]));
	    GetOpenFile(write_io, fptr);
	...
	for (i=0; i<RARRAY_LEN(except); i++) {
            mrb_value io = rb_io_get_io(RARRAY_PTR(except)[i]);
	...
	for (i=0; i< RARRAY_LEN(read); i++) {
	    mrb_value obj = rb_ary_entry(read, i);
	    mrb_value io = rb_io_get_io(obj);
	    GetOpenFile(io, fptr);
	...
	for (i=0; i< RARRAY_LEN(write); i++) {
	    mrb_value obj = rb_ary_entry(write, i);
	    mrb_value io = rb_io_get_io(obj);
	    mrb_value write_io = GetWriteIO(io);
	    GetOpenFile(write_io, fptr);
	...
	for (i=0; i< RARRAY_LEN(except); i++) {
	    mrb_value obj = rb_ary_entry(except, i);
	    mrb_value io = rb_io_get_io(obj);
	    mrb_value write_io = GetWriteIO(io);
	    GetOpenFile(io, fptr);
...
static mrb_value
io_advise_sym_to_const(mrb_value sym)
{
...
static mrb_value
do_io_advise(rb_io_t *fptr, mrb_value advice, off_t offset, off_t len)
{
    int rv;
...
static void
advice_arg_check(mrb_value advice)
{
    if (!SYMBOL_P(advice))
	...
	advice != sym_dontneed &&
	advice != sym_noreuse) {
	mrb_value symname = rb_inspect(advice);
	rb_raise(rb_eNotImpError, "Unsupported advice: %s",
		 Stringmrb_valuePtr(symname));
    }
}
 ...
 *  * <code>Errno::EBADF</code> - The file descriptor of the current file is
      invalid.
 *  * <code>Errno::EINVAL</code> - An invalid mrb_value for _advice_ was given.
 ...
 */
static mrb_value
rb_io_advise(int argc, mrb_value *argv, mrb_value io)
{
 ...
 *  if optional <i>timeout</i> mrb_value is given and no <code>IO</code> object
 ...
 *  timeout:: a numeric mrb_value in second
 *
 *  === Example
 *
 *      rp, wp = IO.pipe
...
static mrb_value
rb_f_select(int argc, mrb_value *argv, mrb_value obj)
{
    mrb_value timeout;
    ...
    return rb_ensure(select_call, (mrb_value)&args, select_end, (mrb_value)&args);
}
...
static long
setup_narg(ioctl_req_t cmd, mrb_value *argp, int io_p)
{
    long narg = 0;
    mrb_value arg = *argp;
	...
	mrb_value tmp = rb_check_string_type(arg);
...
static mrb_value
rb_ioctl(mrb_value io, mrb_value req, mrb_value arg)
{
	...
	if (RSTRING_PTR(arg)[RSTRING_LEN(arg)-1] != 17)
	    rb_raise(rb_eArgError, "return mrb_value overflowed string");
 ...
 *  <i>arg</i> is a number, its mrb_value is passed directly. If it is a
...
static mrb_value
rb_io_ioctl(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value req, arg;
...
#if defined(F_DUPFD)
    if (arg->cmd == F_DUPFD)
	return (mrb_value)rb_cloexec_fcntl_dupfd(arg->fd, (int)arg->narg);
#endif
...
static mrb_value
rb_fcntl(mrb_value io, mrb_value req, mrb_value arg)
{
    int cmd = NUM2INT(req);
    rb_io_t *fptr;
    long narg;
 ...
 *  dependent. If <i>arg</i> is a number, its mrb_value is passed
...
static mrb_value
rb_io_fcntl(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value req, arg;
...
static mrb_value
rb_f_syscall(int argc, mrb_value *argv)
{
#ifdef atarist
...
# define RETVAL2NUM(x) INT2NUM(x)
    ...
    for (i = argc - 1; i--; ) {
	mrb_value v = rb_check_string_type(argv[i]);

	if (!NIL_P(v)) {
	    SafeStringmrb_value(v);
	    rb_str_modify(v);
	    arg[i] = (mrb_value)Stringmrb_valueCStr(v);
	}
	else {
...
static mrb_value
io_new_instance(mrb_value args)
{
    return rb_class_new_instance(2, (mrb_value*)args+1, *(mrb_value*)args);
}

static void
io_encoding_set(rb_io_t *fptr, mrb_value v1, mrb_value v2, mrb_value opt)
{
    rb_encoding *enc, *enc2;
...
static mrb_value
rb_io_s_pipe(int argc, mrb_value *argv, mrb_value klass)
{
    int pipes[2], state;
    ...
    r = rb_protect(io_new_instance, (mrb_value)args, &state);
    if (state) {
	close(pipes[0]);
	close(pipes[1]);
	rb_jump_tag(state);
    ...
    w = rb_protect(io_new_instance, (mrb_value)args, &state);
    if (state) {
	close(pipes[1]);
	...
	rw[0] = r;
	rw[1] = w;
	return rb_ensure(rb_yield, ret, pipe_pair_close, (mrb_value)rw);
    }
    return ret;
}
...
static void
open_key_args(int argc, mrb_value *argv, mrb_value opt, struct foreach_arg *arg)
{
    mrb_value path, v;

    path = *argv++;
    argc--;
    FilePathmrb_value(path);
    arg->io = 0;
    arg->argc = argc;
    arg->argv = argv;
    if (NIL_P(opt)) {
...
static mrb_value
rb_io_s_foreach(int argc, mrb_value *argv, mrb_value self)
{
    mrb_value opt;
    int orig_argc = argc;
    ...
    return rb_ensure(io_s_foreach, (mrb_value)&arg, rb_io_close, arg.io);
}
...
static mrb_value
rb_io_s_readlines(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value opt;
    struct foreach_arg arg;
    ...
    open_key_args(argc, argv, opt, &arg);
    if (NIL_P(arg.io)) return Qnil;
    return rb_ensure(io_s_readlines, (mrb_value)&arg, rb_io_close, arg.io);
}
...
static mrb_value
seek_before_access(mrb_value argp)
{
...
static mrb_value
rb_io_s_read(int argc, mrb_value *argv, mrb_value io)
{
	...
	sarg.offset = offset;
	sarg.mode = SEEK_SET;
	rb_protect(seek_before_access, (mrb_value)&sarg, &state);
	if (state) {
	    rb_io_close(arg.io);
	    rb_jump_tag(state);
	}
    ...
    return rb_ensure(io_s_read, (mrb_value)&arg, rb_io_close, arg.io);
}
...
static mrb_value
rb_io_s_binread(int argc, mrb_value *argv, mrb_value io)
{
    mrb_value offset;
    struct foreach_arg arg;

    rb_scan_args(argc, argv, "12", NULL, NULL, &offset);
    FilePathmrb_value(argv[0]);
...
static mrb_value
io_s_write(int argc, mrb_value *argv, int binary)
{
    ...
    return rb_ensure(io_s_write0, (mrb_value)&warg, rb_io_close, arg.io);
}
...
static mrb_value
rb_io_s_write(int argc, mrb_value *argv, mrb_value io)
{
...
static mrb_value
rb_io_s_binwrite(int argc, mrb_value *argv, mrb_value io)
{
...
# if SIZEOF_OFF_T > SIZEOF_SIZE_T
    /* we are limited by the 32-bit ssize_t return mrb_value on 32-bit */
...
static mrb_value
copy_stream_fallback_body(mrb_value arg)
{
    struct copy_stream_struct *stp = (struct copy_stream_struct *)arg;
    const int buflen = 16*1024;
    mrb_value n;
    mrb_value buf = rb_str_buf_new(buflen);
...
copy_stream_fallback(struct copy_stream_struct *stp)
{
    ...
    rb_rescue2(copy_stream_fallback_body, (mrb_value)stp,
               (mrb_value (*) (ANYARGS))0, (mrb_value)0,
               rb_eEOFError, (mrb_value)0);
    return Qnil;
}

static mrb_value
copy_stream_body(mrb_value arg)
{
    struct copy_stream_struct *stp = (struct copy_stream_struct *)arg;
...
static mrb_value
copy_stream_finalize(mrb_value arg)
{
    struct copy_stream_struct *stp = (struct copy_stream_struct *)arg;
    if (stp->close_src) {
 ...
 */
static mrb_value
rb_io_s_copy_stream(int argc, mrb_value *argv, mrb_value io)
{
    ...
    rb_fd_init(&st.fds);
    rb_ensure(copy_stream_body, (mrb_value)&st, copy_stream_finalize, (mrb_value)&st);
...
static mrb_value
rb_io_external_encoding(mrb_value io)
{
    rb_io_t *fptr;
...
static mrb_value
rb_io_internal_encoding(mrb_value io)
{
    rb_io_t *fptr;
...
static mrb_value
rb_io_set_encoding(int argc, mrb_value *argv, mrb_value io)
{
    rb_io_t *fptr;
    mrb_value v1, v2, opt;
...
{
    extern mrb_value rb_stdin, rb_stdout, rb_stderr;
    mrb_value val = Qnil;
 ...
 */
static mrb_value
argf_external_encoding(mrb_value argf)
{
 ...
 *  mrb_value is returned. Failing that, if a default external encoding was
 *  specified on the command-line, that mrb_value is used. If the encoding is
 *  unknown, nil is returned.
 */
static mrb_value
argf_internal_encoding(mrb_value argf)
{
    if (!RTEST(ARGF.current_file)) {
	return rb_enc_from_encoding(rb_default_external_encoding());
    }
 ...
 */
static mrb_value
argf_set_encoding(int argc, mrb_value *argv, mrb_value argf)
{
    rb_io_t *fptr;
 ...
 *  the mrb_value of _whence_. See +IO#seek+ for further details.
 */
static mrb_value
argf_seek_m(int argc, mrb_value *argv, mrb_value argf)
{
    if (!next_argv()) {
 ...
 */
static mrb_value
argf_set_pos(mrb_value argf, mrb_value offset)
{
    if (!next_argv()) {
...
static mrb_value
argf_read(int argc, mrb_value *argv, mrb_value argf)
{
...
static mrb_value
argf_forward_call(mrb_value arg)
{
...
static mrb_value
argf_readpartial(int argc, mrb_value *argv, mrb_value argf)
{
...
static mrb_value
argf_read_nonblock(int argc, mrb_value *argv, mrb_value argf)
{
    return argf_getpartial(argc, argv, argf, 1);
}

static mrb_value
argf_getpartial(int argc, mrb_value *argv, mrb_value argf, int nonblock)
{
    mrb_value tmp, str, length;
	...
	arg.argv = argv;
	arg.argf = argf;
	tmp = rb_rescue2(argf_forward_call, (mrb_value)&arg,
			 RUBY_METHOD_FUNC(0), Qnil, rb_eEOFError, (mrb_value)0);
    }
    else {
 ...
 */
static mrb_value
argf_each_line(int argc, mrb_value *argv, mrb_value argf)
{
...
static mrb_value
argf_filename_getter(ID id, mrb_value *var)
{
 ...
 *  inplace-edit mode. This mrb_value can be set using +ARGF.inplace_mode=+ or
 *  passing the +-i+ switch to the Ruby binary.
 */
static mrb_value
argf_inplace_mode_get(mrb_value argf)
{
 ...
 *  Each file being edited has this mrb_value appended to its filename. The
 ...
 */
static mrb_value
argf_inplace_mode_set(mrb_value argf, mrb_value val)
{
...
static void
opt_i_set(mrb_value val, ID id, mrb_value *var)
{
 ...
 */
static mrb_value
argf_argv(mrb_value argf)
{
    return ARGF.argv;
}

static mrb_value
argf_argv_getter(ID id, mrb_value *var)
{
 ...
 */
static mrb_value
argf_write(mrb_value argf, mrb_value str)
{
 ...
 *  mrb_values listed in the following table.
 *
 *    Mode |  Meaning
 *    -----+--------------------------------------------------------
