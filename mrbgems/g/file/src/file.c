...
#define FL_MARK      (((mrb_vale)1)<<5)
#define FL_RESERVED  (((mrb_value )1)<<6) /* will be used in the future GC */
#define FL_FINALIZE  (((mrb_value )1)<<7)
#define FL_TAINT     (((mrb_value )1)<<8)
#define FL_UNTRUSTED (((mrb_value )1)<<9)
#define FL_EXIVAR    (((mrb_value )1)<<10)
#define FL_FREEZE    (((mrb_value )1)<<11)
...
static mrb_value
file_path_convert(mrb_state *mrb,mrb_value name)
{
#ifndef _WIN32 /* non Windows == Unix */

    mrb_encoding *fname_encoding = mrb_enc_from_index(mrb,(int)ENCODING_GET(mrb,name));
    mrb_encoding *fs_encoding;
    if (mrb_default_internal_encoding(mrb) != NULL
	    && mrb_usascii_encoding(mrb) != fname_encoding
	    && mrb_ascii8bit_encoding(mrb) != fname_encoding
	    && (fs_encoding = mrb_filesystem_encoding(mrb)) != fname_encoding
	    && !mrb_enc_str_asciionly_p(mrb,name)) {
...
static mrb_value 
rb_get_path_check(mrb_value obj, int level)
{
    mrb_value tmp;
    ID to_path;
    mrb_encoding *enc;
...
VALUE
rb_get_path_no_checksafe(mrb_value obj)
{
    return rb_get_path_check(obj, 0);
}

VALUE
rb_get_path(mrb_value obj)
{
    return rb_get_path_check(obj, rb_safe_level());
}

VALUE
rb_str_encode_ospath(mrb_value path)
{
#ifdef _WIN32
...
static long
apply2files(void (*func)(const char *, VALUE, void *), mrb_value vargs, void *arg)
{
    long i;
    volatile mrb_value path;
...
static mrb_value 
stat_new_0(mrb_value klass, struct stat *st)
{
    struct stat *nst = 0;
...
static mrb_value 
rb_stat_cmp(mrb_value self, mrb_value other)
{
...
static mrb_value 
rb_stat_dev_major(mrb_value self)
{
#if defined(major)
...
static mrb_value 
rb_stat_dev_minor(mrb_value self)
{
#if defined(minor)
...
static mrb_value 
rb_stat_rdev_major(mrb_value self)
{
...
static mrb_value 
rb_stat_rdev_minor(mrb_value self)
{
...
static mrb_value 
rb_stat_blksize(mrb_value self)
{
...
static mrb_value 
rb_stat_inspect(mrb_value self)
{
    mrb_value str;
    size_t i;
    static const struct {
        const char *name;
        mrb_value (*func)(VALUE);
    } member[] = {
        {"dev",	    rb_stat_dev},
        {"ino",	    rb_stat_ino},
        {"mode",    rb_stat_mode},
...
static int
rb_stat(mrb_value file, struct stat *st)
{
    mrb_value tmp;
...
#ifdef _WIN32
static HANDLE
w32_io_info(mrb_value *file, BY_HANDLE_FILE_INFORMATION *st)
{
    mrb_value tmp;
    HANDLE f, ret = 0;
...
static mrb_value 
rb_file_s_stat(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_s_lstat(mrb_value klass, mrb_value fname)
{
#ifdef HAVE_LSTAT
    struct stat st;
...
VALUE
rb_file_directory_p(mrb_value obj, mrb_value fname)
{
#ifndef S_ISDIR
...
static mrb_value 
rb_file_pipe_p(mrb_value obj, mrb_value fname)
{
#ifdef S_IFIFO
#  ifndef S_ISFIFO
...
static mrb_value 
rb_file_symlink_p(mrb_value obj, mrb_value fname)
{
#ifndef S_ISLNK
#  ifdef _S_ISLNK
...
static mrb_value 
rb_file_socket_p(mrb_value obj, mrb_value fname)
{
#ifndef S_ISSOCK
#  ifdef _S_ISSOCK
...
static mrb_value 
rb_file_blockdev_p(mrb_value obj, mrb_value fname)
{
#ifndef S_ISBLK
#   ifdef S_IFBLK
 ...
 */
static mrb_value 
rb_file_chardev_p(mrb_value obj, mrb_value fname)
{
#ifndef S_ISCHR
...
static mrb_value 
rb_file_exist_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_readable_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_readable_real_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_world_readable_p(mrb_value obj, mrb_value fname)
{
#ifdef S_IROTH
    struct stat st;
...
static mrb_value 
rb_file_writable_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_writable_real_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_world_writable_p(mrb_value obj, mrb_value fname)
{
#ifdef S_IWOTH
    struct stat st;
...
static mrb_value 
rb_file_executable_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_executable_real_p(mrb_value obj, mrb_value fname)
{
    rb_secure(2);
    FilePathValue(fname);
    fname = rb_str_encode_ospath(fname);
...
static mrb_value 
rb_file_file_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_zero_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_size_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_owned_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_rowned_p(mrb_value obj, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_grpowned_p(mrb_value obj, mrb_value fname)
{
#ifndef _WIN32
    struct stat st;
...
static mrb_value 
check3rdbyte(mrb_value fname, int mode)
{
    struct stat st;
...
static mrb_value 
rb_file_suid_p(mrb_value obj, mrb_value fname)
{
#ifdef S_ISUID
...
static mrb_value 
rb_file_sgid_p(mrb_value obj, mrb_value fname)
{
#ifdef S_ISGID
...
static mrb_value 
rb_file_sticky_p(mrb_value obj, mrb_value fname)
{
#ifdef S_ISVTX
...
static mrb_value 
rb_file_identical_p(mrb_value obj, mrb_value fname1, mrb_value fname2)
{
#ifndef DOSISH
    struct stat st1, st2;
...
static mrb_value 
rb_file_s_size(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_s_ftype(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_s_atime(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_s_mtime(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static mrb_value 
rb_file_s_ctime(mrb_value klass, mrb_value fname)
{
    struct stat st;
...
static void
chmod_internal(const char *path, mrb_value pathv, void *mode)
{
...
static mrb_value 
rb_file_s_chmod(int argc, mrb_value *argv)
{
    mrb_value vmode;
    mrb_value rest;
    int mode;
...
static mrb_value 
rb_file_chmod(mrb_value obj, mrb_value vmode)
{
    rb_io_t *fptr;
    int mode;
#ifndef HAVE_FCHMOD
...
static void
lchmod_internal(const char *path, mrb_value pathv, void *mode)
{
...
static mrb_value 
rb_file_s_lchmod(int argc, mrb_value *argv)
{
    mrb_value vmode;
    mrb_value rest;
    long mode, n;
...
static void
chown_internal(const char *path, mrb_value pathv, void *arg)
{
...
static mrb_value 
rb_file_s_chown(int argc, mrb_value *argv)
{
    mrb_value o, g, rest;
...
static mrb_value 
rb_file_chown(mrb_value obj, mrb_value owner, mrb_value group)
{
    rb_io_t *fptr;
    int o, g;
#ifndef HAVE_FCHOWN
...
static void
lchown_internal(const char *path, mrb_value pathv, void *arg)
{
    struct chown_args *args = arg;
...
static mrb_value 
rb_file_s_lchown(int argc, mrb_value *argv)
{
    mrb_value o, g, rest;
    struct chown_args arg;
    long n;
...
static void
utime_failed(mrb_value path, const struct timespec *tsp, mrb_value atime, mrb_value mtime)
{
    if (tsp && errno == EINVAL) {
        mrb_value e[2], a = Qnil, m = Qnil;
        int d = 0;
        if (!NIL_P(atime)) {
            a = rb_inspect(atime);
        }
...
static void
utime_internal(const char *path, mrb_value pathv, void *arg)
{
...
static mrb_value 
rb_file_s_utime(int argc, mrb_value *argv)
{
    mrb_value rest;
...
static void
sys_fail2(mrb_value s1, mrb_value s2)
{
    mrb_value str;
#ifdef MAX_PATH
...
static mrb_value 
rb_file_s_link(mrb_value klass, mrb_value from, mrb_value to)
{
    rb_secure(2);
    FilePathValue(from);
    FilePathValue(to);
...
static mrb_value 
rb_file_s_symlink(mrb_value klass, mrb_value from, mrb_value to)
{
    rb_secure(2);
    FilePathValue(from);
    FilePathValue(to);
...
#ifdef HAVE_READLINK
static mrb_value rb_readlink(mrb_value path);
...
static mrb_value 
rb_file_s_readlink(mrb_value klass, mrb_value path)
{
    return rb_readlink(path);
}

static mrb_value 
rb_readlink(mrb_value path)
{
    char *buf;
    int size = 100;
    ssize_t rv;
...
static void
unlink_internal(const char *path, mrb_value pathv, void *arg)
{
    if (unlink(path) < 0)
        rb_sys_fail_path(pathv);
}
...
static mrb_value 
rb_file_s_unlink(mrb_value klass, mrb_value args)
{
    long n;
...
static mrb_value 
rb_file_s_rename(mrb_value klass, mrb_value from, mrb_value to)
{
    const char *src, *dst;
    mrb_value f, t;
 ...
 *
 *  Returns the current umask mrb_value for this process. If the optional
 *  argument is given, set the umask to that mrb_value and return the
...
static mrb_value 
rb_file_s_umask(int argc, mrb_value *argv)
{
    int omask = 0;
...
static inline int
not_same_drive(mrb_value path, int drive)
{
...
VALUE
rb_home_dir(const char *user, mrb_value result)
{
    const char *dir;
    char *buf;
#if defined DOSISH || defined __CYGWIN__
...
#ifndef _WIN32
static char *
append_fspath(mrb_value result, mrb_value fname, char *dir, rb_encoding **enc, rb_encoding *fsenc)
{
    char *buf, *cwdp = dir;
    mrb_value dirname = Qnil;
...
VALUE
rb_file_expand_path_internal(mrb_value fname, mrb_value dname, int abs_mode, int long_name, mrb_value result)
{
    const char *s, *b, *fend;
...
static mrb_value 
file_expand_path_1(mrb_value fname)
{
    return rb_file_expand_path_internal(fname, Qnil, 0, 0, EXPAND_PATH_BUFFER());
}

VALUE
rb_file_expand_path(mrb_value fname, mrb_value dname)
{
...
VALUE
rb_file_expand_path_fast(mrb_value fname, mrb_value dname)
{
    check_expand_path_args(fname, dname);
...
VALUE
rb_file_s_expand_path(int argc, mrb_value *argv)
{
    mrb_value fname, dname;
...
VALUE
rb_file_absolute_path(mrb_value fname, mrb_value dname)
{
    check_expand_path_args(fname, dname);
...
VALUE
rb_file_s_absolute_path(int argc, mrb_value *argv)
{
    mrb_value fname, dname;
...
static void
realpath_rec(long *prefixlenp, mrb_value *resolvedp, const char *unresolved, mrb_value loopcheck, int strict, int last)
{
    ...
    while (unresolved < pend) {
        ...
        if (testnamelen == 1 && testname[0] == '.') {
            ...
            mrb_value checkval;
            mrb_value testpath = rb_str_dup(*resolvedp);
            ...
            if (!NIL_P(checkval)) {
                ...
                struct stat sbuf;
                int ret;
                mrb_value testpath2 = rb_str_encode_ospath(testpath);
...
#endif
                {
                    mrb_value s = rb_str_dup_frozen(testpath);
...
VALUE
rb_realpath_internal(mrb_value basedir, mrb_value path, int strict)
{
    long prefixlen;
    mrb_value resolved;
    volatile mrb_value unresolved_path;
    mrb_value loopcheck;
    volatile mrb_value curdir = Qnil;
 ...
 */
static mrb_value 
rb_file_s_realpath(int argc, mrb_value *argv, mrb_value klass)
{
    mrb_value path, basedir;
 ...
 */
static mrb_value 
rb_file_s_realdirpath(int argc, mrb_value *argv, mrb_value klass)
{
    mrb_value path, basedir;
    rb_scan_args(argc, argv, "11", &path, &basedir);
...
static mrb_value 
rb_file_s_basename(int argc, mrb_value *argv)
{
    mrb_value fname, fext, basename;
    const char *name, *p;
    long f, n;
    rb_encoding *enc;
...
static mrb_value 
rb_file_s_dirname(mrb_value klass, mrb_value fname)
{
    return rb_file_dirname(fname);
}

VALUE
rb_file_dirname(mrb_value fname)
{
...
static mrb_value 
rb_file_s_extname(mrb_value klass, mrb_value fname)
{
    const char *name, *e;
    long len;
    mrb_value extname;
...
static mrb_value 
rb_file_s_path(mrb_value klass, mrb_value fname)
{
...
static mrb_value 
rb_file_s_split(mrb_value klass, mrb_value path)
{
    FilePathStringValue(path);		/* get rid of converting twice */
    return rb_assoc_new(rb_file_s_dirname(Qnil, path), rb_file_s_basename(1,&path));
}

static mrb_value separator;

static mrb_value rb_file_join(mrb_value ary, mrb_value sep);

static mrb_value 
file_inspect_join(mrb_value ary, mrb_value argp, int recur)
{
    mrb_value *arg = (mrb_value *)argp;
    if (recur || ary == arg[0]) rb_raise(rb_eArgError, "recursive array");
    return rb_file_join(arg[0], arg[1]);
}

static mrb_value 
rb_file_join(mrb_value ary, mrb_value sep)
{
    long len, i;
...
static mrb_value 
rb_file_s_join(mrb_value klass, mrb_value args)
{
...
static mrb_value 
rb_file_s_truncate(mrb_value klass, mrb_value path, mrb_value len)
{
    off_t pos;
...
static mrb_value 
rb_file_truncate(mrb_value obj, mrb_value len)
{
    rb_io_t *fptr;
    off_t pos;
...
static mrb_value 
rb_file_flock(mrb_value obj, mrb_value operation)
{
    rb_io_t *fptr;
    int op[2], op1;
...
static void
test_check(int n, int argc, mrb_value *argv)
{
    int i;
...
static mrb_value 
rb_f_test(int argc, mrb_value *argv)
{
    int cmd;
...
static mrb_value 
rb_stat_s_alloc(mrb_value klass)
{
...
static mrb_value 
rb_stat_init(mrb_value obj, mrb_value fname)
{
    struct stat st, *nst;
...
/* :nodoc: */
static mrb_value 
rb_stat_init_copy(mrb_value copy, mrb_value orig)
{
    struct stat *nst;
...
static mrb_value 
rb_stat_grpowned(mrb_value obj)
{
#ifndef _WIN32
...
mrb_value rb_mFConst;

void
rb_file_const(const char *name, mrb_value value)
{
...
static int
path_check_0(mrb_value path, int execpath)
{
    struct stat st;
...
static mrb_value 
copy_path_class(mrb_value path, mrb_value orig)
{
...
int
rb_find_file_ext(mrb_value *filep, const char *const *ext)
{
    return rb_find_file_ext_safe(filep, ext, rb_safe_level());
}

int
rb_find_file_ext_safe(mrb_value *filep, const char *const *ext, int safe_level)
{
    const char *f = StringValueCStr(*filep);
    mrb_value fname = *filep, load_path, tmp;
    long i, j, fnlen;
    int expanded = 0;
    ...
    for (j=0; ext[j]; j++) {
        ...
        for (i = 0; i < RARRAY_LEN(load_path); i++) {
            mrb_value str = RARRAY_PTR(load_path)[i];
...
VALUE
rb_find_file(mrb_value path)
{
    return rb_find_file_safe(path, rb_safe_level());
}

VALUE
rb_find_file_safe(mrb_value path, int safe_level)
{
    mrb_value tmp, load_path;
...
static void
define_filetest_function(const char *name, mrb_value (*func)(ANYARGS), int argc)
{
...
mrb_file_gem_init(mrb_state* mrb) {
    struct RClass* _class_cextension = mrb_define_module(mrb, "CRubyExtension");
